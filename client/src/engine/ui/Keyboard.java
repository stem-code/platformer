...
public final class Keyboard {
    public static final int KEYBOARD_SIZE = 65536;
            ...
            GLFW.glfwSetKeyCallback(window, new GLFWKeyCallback() {
                ...
                public void invoke(long window, int key, int scanCode, int action, int mods) {
                    ...
                    for (KeyboardListener keyboardListener : keyboardListeners) {
                        keyboardListener.onKeyPressed(key, scanCode, action, mods);
                    }
                }
            });
        }
    ...
    public static boolean isKeyPressed(int keyCode) {
        return keyActions[keyCode] != GLFW.GLFW_RELEASE;
    }

    public static int getKeyAction(int keyCode) {
        return keyActions[keyCode];
    }

    public static void print() {
        System.out.println("Key States: " + Arrays.toString(keyActions));
    }
